    ...
    return (
        ...
        <div class="container" style={{width:'1000px',}}>
            <div className="header" >
                ...
                <Dropdown>
                    <Dropdown.Toggle variant="success" id="dropdown-basic"> Thể Loại
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
            ...
            <h1 style={{'margin':'30px 200px',color:'chocolate'}}>Thêm Bài Đăng</h1>
            ...
            <div class="form-group"style={{margin:'10px 80px',padding:'10px'}}>
                ...
                <label for="inputtitle" class="col-sm-2 control-label">Thể Loại:</label>
            ...
            <div class="form-group"style={{margin:'50px 80px',padding:'10px'}}>
                ...
                <label for="inputImages" class="col-sm-2 control-label">Hình Ảnh:</label>
                <div class="col-sm-10">
                <input class="form-control" type="file" id="formFile"/>
                </div>
            </div>
            <div class="form-group"style={{margin:'50px 80px',padding:'10px'}}>
                <label for="textareadetail" class="col-sm-2 control-label">Chi Tiết:</label>
                <div class="col-sm-10">
                    <textarea name="detail" id="textareadetail" onChange={onValueChangeDetail}  class="form-control" rows="3" required="required"></textarea>
                </div>
            </div><br/>
            
            <button type="button" class="btn btn-success" id='add' onClick={onAdd}style={{"margin":'10px 270px','margin-bottom':'30px'}}>Thêm Bài Đăng</button>
        </div>
    );
}
