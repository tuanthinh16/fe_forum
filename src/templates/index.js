            ...
            <div className="content" style={{'padding':'10px 0px'}}>
                {postt.map((row) =>(
                    ...
                    <div className="row" style={{'height': '300px'}}>
                        <div className="col" >
                            <img src="https://img.nhandan.com.vn/Files/Images/2020/07/26/nhat_cay-1595747664059.jpg" alt="dogs" class="img-thumbnail" style={{'max-width': '300px','max-height': '300px', 'padding': '0px 15px'}}></img>
                        </div>
                        <div className="col">
                            <Card.Body>             
