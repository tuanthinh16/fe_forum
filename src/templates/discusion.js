            ...
            <div className="content">
                {postt.map((row) => (
                    <Card>
                        ...
                        {islogin
                            ? <><Form.Label>Bạn có suy nghĩ gì về bài viết này!</Form.Label>
                                <Form.Control as='textarea' row='3' onChange={onValueChange} name='comment'></Form.Control>
                                <Button class="btn btn-outline-primary" variant="primary" id='push-comment' type="submit" onClick={onSubmit}>Bình Luận
                                </Button></>
